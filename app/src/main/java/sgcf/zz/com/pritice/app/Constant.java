...
public class Constant {
    ...
    public static String PATH_DATA = FileUtils.createRootPath(MyApplication.getInstance()) + "/cache";

    public static String PATH_COLLECT = FileUtils.createRootPath(MyApplication.getInstance()) + "/collect";
